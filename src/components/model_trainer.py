...
from src.components.model_parameters import params
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            ...
            # Get the best performing model from model_report
            ...
            logging.info(f"Best model {best_model_name} found on both training and test dataset with test score {best_model_score}")
